...
def cadastro_pessoa_fisica():
    ...
    return jsonify({'message': 'Pessoa Física cadastrada com sucesso'}), 201
...
def cadastro_pessoa_juridica():
    ...
    return jsonify({'message': 'Pessoa Jurídica cadastrada com sucesso'}), 201
...
def deletar_pessoa(id):
    ...
    # Verificar se a pessoa é física ou jurídica e deletar os dados nas tabelas correspondentes
    ...
    # Após excluir os dados nas tabelas filhas, excluir da tabela Pessoa
